...
<div class="navbar navbar-inverse">
	<div class="container z0">
		<div class="navbar-header">
			<span class="navbar-brand" href="#">Edit Profil</span>
		</div>
	</div><!-- /.container -->
</div><!-- /.navbar -->
	...
	<div class="col-lg-6">
		...
		<tr><td width="20%">Deskripsi</td>
			<td colspan="2"><b><textarea rows="7" name="deskripsi" class="form-control"><?php echo $deskripsi; ?></textarea></b></td>
		</tr>
		<tr><td colspan="2">
