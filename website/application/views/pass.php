...
<div class="well">
<form action="<?php echo base_URL()?>index.php/welcome/password/simpan" method="post" accept-charset="utf-8" enctype="multipart/form-data">	

	<table class="table-form" width="100%">
	<tr><td width="20%">id</td><td><b><input type="text" name="username" class="form-control" readonly value="<?=$this->session->userdata('admin_id')?>" style="width: 200px"></b></td></tr>		
	...
	<a href="<?php echo base_URL()?>index.php/welcome/masuk" class="btn btn-success"><i class="icon icon-arrow-left icon-white"></i> Kembali</a>
	</td></tr>
	</table>
	</fieldset>
</form>
